...
pipeline {
    ...
    post {
    success {
        discordSend description: "TODO APP : deploy is success to branch $env.BRANCH_NAME", footer: '', image: '', link: env.JENKINS_URL, result: env.BUILD_URL, scmWebUrl: '', thumbnail: '', title: "Notification success build from : $env.JOB_NAME", webhookURL: env.DISCORD_URL
    }
    failure {
             discordSend description: "TODO APP : deploy is failed to branch $env.BRANCH_NAME", footer: '', image: '', link: env.JENKINS_URL, result: env.BUILD_URL, scmWebUrl: '', thumbnail: '', title: "Notification failed build from : $env.JOB_NAME", webhookURL: env.DISCORD_URL
         }
    }
}
